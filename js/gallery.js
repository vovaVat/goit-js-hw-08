...
const galleryItems = images.map((obj) => `<li class="gallery-item"><a class="gallery-link" ><img data-source="${obj.original}" class="gallery-image" src="${obj.preview}" alt="${obj.description}" /></a></li>`).join("");

const imgUl= document.querySelector(".gallery");
    
imgUl.insertAdjacentHTML('beforeend', galleryItems);

imgUl.addEventListener('click', (elem) => {
